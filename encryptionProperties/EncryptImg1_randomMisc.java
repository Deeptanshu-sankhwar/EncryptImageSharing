...
public class EncryptImg1_randomMisc
{
	...
	public static void main(String args[]) throws IOException{
		...
		//creation of required images by initalising them to default

		f = new File("gXrnd.jpg");
		ImageIO.write(img,"jpg",f);
		f = new File("gYrnd.jpg");
		ImageIO.write(img,"jpg",f);
		f = new File("gZrnd.jpg");
		ImageIO.write(img,"jpg",f);
		f = new File("gMiscrnd.jpg");
		ImageIO.write(img,"jpg",f);
		f = new File("gKey.jpg");
		ImageIO.write(img,"jpg",f);
		...
		for (int i = 0; i < height; i++)	{
			for(int j = 0; j < width; j++)	{
				...
				//randomising tone distribution in misc image using modular encryption
				else{
		...
		System.out.println(imgx.getRGB(32,56));
		System.out.println(key.getRGB(32,56));
		...
		System.out.print(imgx.getRGB(32,56));
